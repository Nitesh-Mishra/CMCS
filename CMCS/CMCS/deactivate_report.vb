...
Public Class deactivate_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CMCS.deactivate_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_vmemberid() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cacheddeactivate_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As deactivate_report = New deactivate_report
        rpt.Site = Me.Site
        Return rpt
    End Function
