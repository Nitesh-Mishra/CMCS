...
Public Class two_month_defaulters
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "two_month_defaulters.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CMCS.two_month_defaulters.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_mid() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedtwo_month_defaulters
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As two_month_defaulters = New two_month_defaulters
        rpt.Site = Me.Site
        Return rpt
    End Function
